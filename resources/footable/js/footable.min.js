...
!(function (a, b) {
            ...
            b.arr.each(c.ft.columns.array, function (b) {
              b.sortable &&
                b.$el
                  ...
                  .append(a("<span/>", { class: "fooicon fa fa-caret-down pl-2" }));
            }),
              c.ft.$el.on(
                "click.footable",
                ".footable-sortable",
      ...
      draw: function () {
        if (this.column) {
          ...
          b
            ...
            .children(".fooicon")
            .removeClass("fa fa-caret-down fa fa-caret-down-asc fa fa-caret-down-desc"),
            b.not(c).children(".fooicon").addClass("fa fa-caret-down"),
            c
              .addClass(
              ...
              .addClass(
                "DESC" == a.column.direction
                  ? "fa fa-caret-down-desc"
                  : "fa fa-caret-down-asc"
              );
        }
      },
      sort: function (a, b) {
  ...
  (function (a, b) {
    (b.Editing = b.Component.extend({
      ...
      $buttonShow: function () {
        return (
          '<button type="button" class="btn btn-primary text-white footable-show">' +
          this.showText +
          "</button>"
        );
      },
      ...
      $buttonAdd: function () {
        return (
          '<button type="button" class="btn btn-primary text-white footable-add">' +
          this.addText +
          "</button> "
        );
      },
