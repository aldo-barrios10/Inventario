                    ...
                    <div id="sidebar-nav" class="list-group border-0 rounded-0 text-sm-start min-vh-100">
                        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion p-3" id="accordionSidebar">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link btn-secondary" href="index.php">
                            ...
                            <!-- Nav Item - Pages Collapse Menu -->
                            <li class="nav-item m-1">
                                <a class="nav-link btn-secondary" href="sales.php">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link btn-secondary" href="products.php">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link btn-secondary" href="clients.php">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link btn-secondary" href="suppliers.php">
                            ...
                            <?php if ($_SESSION['rol'] == 1) { ?>
                                ...
                                <li class="nav-item m-1">
                                    <a class="nav-link btn-secondary" href="users.php">
